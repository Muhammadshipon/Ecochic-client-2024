...
const LogIn = () => {
  return (
	...
	<div className="flex justify-center space-x-4">
		<button aria-label="Log in with Google" className="p-3 hover:scale-110 rounded-sm">
  ...
  <g className="colors" clipPath="url(#g)">
    ...
    <path fill="#4285F4" d="M48 48L17 24l-4-3 35-10z"/>
		...
		<button  aria-label="Log in with GitHub" className="p-3 hover:scale-110  rounded-sm">
