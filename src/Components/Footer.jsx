...
const Footer = () => {
  return (
    ...
    <div className="">
			<h1 className="text-2xl font-bold text-gray-300">Contact us</h1>
  ...
  <footer className="footer footer-center p-4 bg-gray-900 text-white border-t-2 border-white border-dashed pb-5">
    <aside>
